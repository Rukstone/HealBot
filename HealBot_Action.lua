...
local _healbotSetSpell_T = {
    [HEALBOT_DRUID] = {
        ['h'] = HEALBOT_REJUVENATION,
        ['b'] = HEALBOT_MARK_OF_THE_WILD,
        ['d'] = HEALBOT_CURE_POISON,
        ['r'] = HEALBOT_REVIVE
    },
    [HEALBOT_HUNTER] = {
        ['h'] = HEALBOT_MENDPET,
    ...
    [HEALBOT_MAGE] = {
        ...
        ['b'] = HEALBOT_ARCANE_INTELLECT,
        ['d'] = HEALBOT_REMOVE_CURSE,
    },
    [HEALBOT_PALADIN] = {

        ['h'] = HEALBOT_HOLY_LIGHT,
        ['b'] = HEALBOT_BLESSING_OF_MIGHT,
        ['d'] = HEALBOT_PURIFY,
        ['r'] = HEALBOT_REDEMPTION
    },
    [HEALBOT_PRIEST] = {

        ['h'] = HEALBOT_LESSER_HEAL,
        ['b'] = HEALBOT_POWER_WORD_FORTITUDE,
        ['d'] = HEALBOT_CURE_DISEASE,
        ['r'] = HEALBOT_RESURRECTION
    },
    [HEALBOT_SHAMAN] = {

        ['h'] = HEALBOT_HEALING_WAVE,
        ['b'] = HEALBOT_WATER_SHIELD,
        ['d'] = HEALBOT_CURE_DISEASE,
        ['r'] = HEALBOT_ANCESTRALSPIRIT
    },
    [HEALBOT_WARLOCK] = {

        ['h'] = HEALBOT_HEALTH_FUNNEL,
        ['b'] = HEALBOT_UNENDING_BREATH,
    },
    [HEALBOT_WARRIOR] = {
    ...
    [HEALBOT_SUNCLERIC] = {
        ['h'] = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Shine,
        ['b'] = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Bless,
        ['d'] = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Sanctify,
        ['r'] = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Revivify
    },
    [HEALBOT_VENOMANCER] = {
        ['h'] = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Shadras_Vigil,
        ['b'] = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Shadras_Wisdom,
        ['d'] = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Dark_Barrier,
        ['r'] = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Prayer_Beads
    },
    [HEALBOT_PRIMALIST] = {
        ['h'] = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].Hand_of_the_Earthmother,
        ['b'] = HEALBOT_CLASS_SPELLS[HEALBOT_PRIMALIST].Primal_Instinct,
        ['r'] = HEALBOT_CLASS_SPELLS[HEALBOT_PRIMALIST].Return_to_Life,
...
function HealBot_Action_SetrSpell()
    ...
    if _healbotSetSpell_T[HealBot_PlayerClass_ER] then
        if _healbotSetSpell_T[HealBot_PlayerClass_ER]["h"] then
            HealBot_hSpell = _healbotSetSpell_T[HealBot_PlayerClass_ER]["h"]
        end
        if _healbotSetSpell_T[HealBot_PlayerClass_ER]["b"] then
            HealBot_bSpell = _healbotSetSpell_T[HealBot_PlayerClass_ER]["b"]
        end
        if _healbotSetSpell_T[HealBot_PlayerClass_ER]["d"] then
            HealBot_dSpell = _healbotSetSpell_T[HealBot_PlayerClass_ER]["d"]
        end
        if _healbotSetSpell_T[HealBot_PlayerClass_ER]["r"] then
            HealBot_rSpell = _healbotSetSpell_T[HealBot_PlayerClass_ER]["r"]
        end
    else
        ...
        elseif HealBot_PlayerClass_ER == HEALBOT_SUNCLERIC then
            HealBot_hSpell = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Shine
            HealBot_bSpell = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Bless
            HealBot_dSpell = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Sanctify
            HealBot_rSpell = HEALBOT_CLASS_SPELLS[HEALBOT_SUNCLERIC].SunCleric_Revivify
        elseif HealBot_PlayerClass_ER == HEALBOT_VENOMANCER then
            HealBot_hSpell = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Shadras_Vigil
            HealBot_bSpell = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Shadras_Wisdom
            HealBot_dSpell = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Dark_Barrier
            HealBot_rSpell = HEALBOT_CLASS_SPELLS[HEALBOT_VENOMANCER].Venomancer_Prayer_Beads
        end
    end
...
function HealBot_GetBandageType()
    local bandage = ""
    if IsUsableItem(HEALBOT_HEAVY_FROSTWEAVE_BANDAGE) then
        bandage = HEALBOT_HEAVY_FROSTWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_FROSTWEAVE_BANDAGE) then
        bandage = HEALBOT_FROSTWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_HEAVY_NETHERWEAVE_BANDAGE) then
        bandage = HEALBOT_HEAVY_NETHERWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_NETHERWEAVE_BANDAGE) then
        bandage = HEALBOT_NETHERWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_HEAVY_RUNECLOTH_BANDAGE) then
        bandage = HEALBOT_HEAVY_RUNECLOTH_BANDAGE
    elseif IsUsableItem(HEALBOT_RUNECLOTH_BANDAGE) then
        bandage = HEALBOT_RUNECLOTH_BANDAGE
    elseif IsUsableItem(HEALBOT_HEAVY_MAGEWEAVE_BANDAGE) then
        bandage = HEALBOT_HEAVY_MAGEWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_MAGEWEAVE_BANDAGE) then
        bandage = HEALBOT_MAGEWEAVE_BANDAGE
    elseif IsUsableItem(HEALBOT_HEAVY_SILK_BANDAGE) then
        bandage = HEALBOT_HEAVY_SILK_BANDAGE
    elseif IsUsableItem(HEALBOT_SILK_BANDAGE) then
        bandage = HEALBOT_SILK_BANDAGE
    else
...
function HealBot_Action_EnableButton(button, hbGUID)
    ...
    if uName ~= HEALBOT_WORDS_UNKNOWN then
        ...
        ebur, ebug, ebub, ebua, ebpct, ebusa = HealBot_HealthColor(ebUnit, uHlth, uMaxHlth, false, hbGUID, ebuUnitDead,
            ebuHealBot_UnitBuff, ebuHealBot_UnitDebuff, uHealIn)
        ...
        if ebufastenable then
            ...
            if UnitIsVisible(ebUnit) or Healbot_Config_Skins.NotVisibleDisable[Healbot_Config_Skins.Current_Skin] == 0 then
                ...
                ebubar:SetStatusBarColor(ebur, ebug, ebub,
                    Healbot_Config_Skins.bardisa[Healbot_Config_Skins.Current_Skin]);
                if Healbot_Config_Skins.ShowClassOnBar[Healbot_Config_Skins.Current_Skin] == 1 and Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin] == 1 then -- and HealBot_retdebuffTargetIcon(ebUnit) then
    ...
    if uHealIn > 0 then
        ebubar2:SetStatusBarColor(ebur, ebug, ebub, Healbot_Config_Skins.BarcolaInHeal
    ...
    if UnitIsVisible(ebUnit) or Healbot_Config_Skins.NotVisibleDisable[Healbot_Config_Skins.Current_Skin] == 0 then
        ...
        ebubar.txt:SetTextColor(ebusr, ebusg, ebusb,
...
function HealBot_Action_HBText(hlth, maxhlth, unitName, unit, healin, hbGUID)
    ...
    if unitName and unitName == HEALBOT_WORD_RESERVED .. ":" .. unit then
        ...
        bttextlen = floor((hbFontAdj * 2) + 2 +
            (((Healbot_Config_Skins.bwidth[Healbot_Config_Skins.Current_Skin] * 1.88) / Healbot_Config_Skins.btextheight[Healbot_Config_Skins.Current_Skin]) - (Healbot_Config_Skins.btextheight[Healbot_Config_Skins.Current_Skin] / hbFontAdj)))
            ...
            elseif Healbot_Config_Skins.BarHealthType[Healbot_Config_Skins.Current_Skin] == 2 then
                ...
                if bthlthdelta > 0 then
                    btHBbarText = btHBbarText ..
                        " " .. hbNumFormatSurL .. "+" .. bthlthdelta .. hbNumFormatSuffix .. hbNumFormatSurR;
                else
                    btHBbarText = btHBbarText .. hbNumFormatSurL .. bthlthdelta .. hbNumFormatSuffix .. hbNumFormatSurR;
                end
                if Healbot_Config_Skins.BarHealthIncHeals[Healbot_Config_Skins.Current_Skin] == 3 and healin > 0 then
                ...
                if Healbot_Config_Skins.BarHealthIncHeals[Healbot_Config_Skins.Current_Skin] == 2 then
                    btHBbarText = btHBbarText ..
                        hbNumFormatSurL .. floor(((hlth + healin) / maxhlth) * 100) .. "%" .. hbNumFormatSurR
                else
                    btHBbarText = btHBbarText .. hbNumFormatSurL .. floor((hlth / maxhlth) * 100) .. "%" ..
                        hbNumFormatSurR
                end
                if Healbot_Config_Skins.BarHealthIncHeals[Healbot_Config_Skins.Current_Skin] == 3 and healin > 0 then
...
function HealBot_Action_ResetSkin(barType, button, numcols)
    ...
    elseif barType == "hbfocus" then
        HealBot_Action_hbFocusButtonBar:SetStatusBarTexture(LSM:Fetch('statusbar',
        ...
        HealBot_Action_hbFocusButtonBar.txt:SetFont(
            LSM:Fetch('font', Healbot_Config_Skins.btextfont[Healbot_Config_Skins.Current_Skin]), btextheight, "");
    ...
    if HealBot_UnitStatus[unit] > 0 then
        ...
        elseif uRange ~= HealBot_UnitRange[unit] then
            ...
            if uRange == 1 and not HealBot_PlayerDead then
                ebubar:SetStatusBarColor(HealBot_UnitRanger[unit], HealBot_UnitRangeg[unit], HealBot_UnitRangeb[unit],
                    Healbot_Config_Skins.Barcola[Healbot_Config_Skins.Current_Skin])
                ebubar.txt:SetTextColor(HealBot_UnitRangeitr[unit], HealBot_UnitRangeitg[unit],
                    HealBot_UnitRangeitb[unit], Healbot_Config_Skins.btextenabledcola[Healbot_Config_Skins.Current_Skin]);
                if Healbot_Config_Skins.ShowClassOnBar[Healbot_Config_Skins.Current_Skin] == 1 and Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin] == 1 then
            ...
            elseif uRange == 0 or Healbot_Config_Skins.NotVisibleDisable[Healbot_Config_Skins.Current_Skin] == 0 then
                ...
                ebubar:SetStatusBarColor(HealBot_UnitRanger[unit], HealBot_UnitRangeg[unit], HealBot_UnitRangeb[unit],
                    HealBot_UnitRangea[unit])
                ebubar.txt:SetTextColor(HealBot_UnitRangeitr[unit], HealBot_UnitRangeitg[unit],
                    HealBot_UnitRangeitb[unit], HealBot_UnitRangeota[unit]);
                if Healbot_Config_Skins.ShowClassOnBar[Healbot_Config_Skins.Current_Skin] == 1 and Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin] == 1 then
                ...
                ebubar:SetStatusBarColor(HealBot_UnitRanger[unit], HealBot_UnitRangeg[unit], HealBot_UnitRangeb[unit],
                    Healbot_Config_Skins.bardisa[Healbot_Config_Skins.Current_Skin])
                ebubar.txt:SetTextColor(HealBot_UnitRangeotr[unit], HealBot_UnitRangeotg[unit],
                    HealBot_UnitRangeotb[unit], Healbot_Config_Skins.btextdisbledcola[Healbot_Config_Skins.Current_Skin]);
                if Healbot_Config_Skins.ShowClassOnBar[Healbot_Config_Skins.Current_Skin] == 1 and Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin] == 1 then
                    ebuicon15:SetAlpha(Healbot_Config_Skins.bardisa[Healbot_Config_Skins.Current_Skin]);
                end
            end
...
function HealBot_Action_SetButtonAttrib(button, bbutton, bkey, status, j)
    ...
    if sName then
        ...
        elseif strlower(sName) == strlower(HEALBOT_HBMENU) and HealBot_UnitGUID(button.unit) then
            ...
            showHBmenu = function()
                local HBFriendsDropDown = CreateFrame("Frame", "HealBot_Action_hbmenuFrame_DropDown", UIParent,
...
function HealBot_Action_AlterSpell2Macro(spellName, spellTar, spellTrin1, spellTrin2, unit, combo)
    if not smName[combo .. unit] then
        ...
        if HealBot_Config.MacroSuppressSound == 1 and sysSoundSFX == "1" then
            smName[combo .. unit] = smName
                [combo .. unit] .. "/console Sound_EnableSFX 0;\n"
        end
        if HealBot_Config.MacroSuppressError == 1 then
            smName[combo .. unit] = smName[combo .. unit] ..
        ...
        if HealBot_Config.MacroSuppressSound == 1 and sysSoundSFX == "1" then
            smName[combo .. unit] = smName
                [combo .. unit] .. "/console Sound_EnableSFX 1;\n"
        end
        ...
        if strlen(smName[combo .. unit]) > 255 then
            ...
            if strlen(smName[combo .. unit]) > 255 then
                smName[combo .. unit] = ""
                if spellTar == 1 then
                    smName[combo .. unit] = smName[combo .. unit] .. "/target " ..
                        UnitName(unit) .. ";\n"
                end
                if spellTrin1 == 1 then smName[combo .. unit] = smName[combo .. unit] .. "/use 13;\n" end
                if spellTrin2 == 1 then smName[combo .. unit] = smName[combo .. unit] .. "/use 14;\n" end
...
function HealBot_Action_AttribSpellPattern(HB_combo_prefix)
    ...
    return hbCombos[HB_combo_prefix], hbTarget[HB_combo_prefix] or 0, hbTrinket1[HB_combo_prefix] or 0,
        hbTrinket2[HB_combo_prefix] or 0
end
...
function HealBot_Action_ClassColour(hbGUID, unit)
    ...
    if not hbClassCols[class] then
        ...
        hbClassCols[class] = { r = ccolor.r, g = ccolor.g, b = ccolor.b }
    end
        ...
        for ebubar, value in pairs(HealBot_UnitBarUpdate) do
            if value > HealBot_curUnitHealth[ebubar] then
                if value - Healbot_Config_Skins.BarFreq[Healbot_Config_Skins.Current_Skin] <= HealBot_curUnitHealth[ebubar] then
                    ...
                    HealBot_UnitBarUpdate[ebubar] = value -
                        Healbot_Config_Skins.BarFreq[Healbot_Config_Skins.Current_Skin]
                end
    ...
    if HealBot_Action_Timer2 > HB_Action_Timer2 then
        ...
        for xGUID, bar4 in pairs(HealBot_AggroBar4) do
            ...
            if HealBot_AggroUnitThreat == 9 and HealBot_UnitDebuff[xGUID] and HealBot_Config.CDCBarColour[HealBot_UnitDebuff[xGUID]["name"]] then
                ...
                bar4:SetStatusBarColor(HealBot_AggroBarColr[HealBot_AggroUnitThreat],
                    HealBot_AggroBarColg[HealBot_AggroUnitThreat], HealBot_AggroBarColb[HealBot_AggroUnitThreat],
                    HealBot_AggroBarA)
            end
        end
