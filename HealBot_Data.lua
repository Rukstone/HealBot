...
HealBot_GlobalsDefaults = {
    ...
    WatchHoT = {
        ["DRUI"] = { --1 for not displaying 2 for self only 3 for all
            ...
            [HEALBOT_PROTANCIENTKINGS]=2,
            [HEALBOT_HANDOFPROTECTION]=2,
            [HEALBOT_FEAR_WARD]=2,
            [HEALBOT_BLESSED_HEALING]=2,
            [HEALBOT_IMPROVED_LAY_ON_HANDS]=2,
            [HEALBOT_HAND_OF_SALVATION]=2,
