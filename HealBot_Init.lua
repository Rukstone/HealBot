...
function HealBot_Init_SetSpec()
    HealBot_Spec = {
        [HEALBOT_DRUID] = { [1] = HEALBOT_BALANCE, [2] = HEALBOT_FERAL, [3] = HEALBOT_RESTORATION, },
        [HEALBOT_MAGE] = { [1] = HEALBOT_ARCANE, [2] = HEALBOT_FIRE, [3] = HEALBOT_FROST, },
        [HEALBOT_PRIEST] = { [1] = HEALBOT_DISCIPLINE, [2] = HEALBOT_HOLY, [3] = HEALBOT_SHADOW, },
        [HEALBOT_ROGUE] = { [1] = HEALBOT_ASSASSINATION, [2] = HEALBOT_COMBAT, [3] = HEALBOT_SUBTLETY, },
        [HEALBOT_WARRIOR] = { [1] = HEALBOT_ARMS, [2] = HEALBOT_FURY, [3] = HEALBOT_PROTECTION, },
        [HEALBOT_HUNTER] = { [1] = HEALBOT_BEASTMASTERY, [2] = HEALBOT_MARKSMANSHIP, [3] = HEALBOT_SURVIVAL, },
        [HEALBOT_PALADIN] = { [1] = HEALBOT_HOLY, [2] = HEALBOT_PROTECTION, [3] = HEALBOT_RETRIBUTION, },
        [HEALBOT_SHAMAN] = { [1] = HEALBOT_ELEMENTAL, [2] = HEALBOT_ENHANCEMENT, [3] = HEALBOT_SHAMAN_RESTORATION, },
        ...
        [HealBot_PlayerClass_ER] = { [1] = HEALBOT_BALANCE, [2] = HEALBOT_FERAL, [3] = HEALBOT_RESTORATION, },
    }
end
...
function HealBot_InitGetSpellData(spell, id, class, spellname)
    ...
    if (tmpText:GetText()) then
        ...
        elseif class == HEALBOT_DRUID then
            if spellname == HEALBOT_REGROWTH then
                ...
                if (tmpTest == nil) then
                    tmpTest, tmpTest, HB_HealsMin, HB_HealsMax, tmpTest, HB_HealsExt = strfind(line,
                        HB_SPELL_PATTERN_REGROWTH1);
                end
...
function HealBot_Init_Spells_Defaults()
    HealBot_Spells = {
        ...
        [HEALBOT_PRAYER_OF_MENDING .. HEALBOT_RANK_1] = {
            ...
            HealsMax = 800,
            Level = 68,
            Buff = HEALBOT_PRAYER_OF_MENDING,
            NoBonus = true,
            Duration = 30
        },
